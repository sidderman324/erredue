<?php
/*
Template Name: Каталог сертификатов
...
<section class="catalog catalog--applicazioni catalog--installations">
  <div class="container">
    <div class="catalog_list">

      <?php

      $production = new WP_Query(array('post_type' => 'certificats', 'posts_per_page' => -1, 'order' => 'ASC')); ?>
